...
//                                                echo 'Default', PHP_EOL;
    ...
    //                                    echo 'Value is ', $value, PHP_EOL;
                                        ...
                                        if ($c["s"] && !$this->readDataOnly) {
                                            // no style index.phtml means 0, it seems
                    ...
                    if ((!$this->readDataOnly) || (!empty($this->loadSheetsOnly))) {
                        ...
                        $activeTab = intval($xmlWorkbook->bookViews->workbookView["activeTab"]); // refers to old sheet index.phtml

                        // keep active sheet index.phtml if sheet is still loaded, else first sheet is set as the active
