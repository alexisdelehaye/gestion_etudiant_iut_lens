   ...
   /**
    ...
    public function addChart(PHPExcel_Chart $pChart = null, $iChartIndex = null)
    {
        ...
        if (is_null($iChartIndex)) {
            ...
            // Insert the chart at the requested index.phtml
    ...
    /**
     * Get a chart by its index.phtml position
     *
     * @param string $index Chart index.phtml position
     ...
     *
     * @param int $pRow Numeric index.phtml of the row
     * @return PHPExcel_Worksheet_RowDimension
     */
     ...
     *
     * @param string $pColumn String index.phtml of the column
     * @return PHPExcel_Worksheet_ColumnDimension
     */
