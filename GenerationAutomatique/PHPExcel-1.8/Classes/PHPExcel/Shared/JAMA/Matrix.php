...
class PHPExcel_Shared_JAMA_Matrix
{
     ...
     *
     *    Get a submatrix
     *    @param int $i0 Initial row index.phtml
     *    @param int $iF Final row index.phtml
     *    @param int $j0 Initial column index.phtml
     *    @param int $jF Final column index.phtml
     ...
     *    getMatrixByRow
     *
     *    Get a submatrix by row index.phtml/range
     *    @param int $i0 Initial row index.phtml
     *    @param int $iF Final row index.phtml
     *    @return Matrix Submatrix
     */
     ...
     *    getMatrixByCol
     *
     *    Get a submatrix by column index.phtml/range
     *    @param int $i0 Initial column index.phtml
     *    @param int $iF Final column index.phtml
     *    @return Matrix Submatrix
     */
