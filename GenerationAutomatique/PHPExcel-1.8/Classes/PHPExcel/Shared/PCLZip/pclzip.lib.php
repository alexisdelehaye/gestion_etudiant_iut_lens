...
class PclZip
{
    ...
    //         folder : true | false
    //         index.phtml : index.phtml of the file in the archive
    ...
    //     The extracted files or folders are identified by their index.phtml in the
    //     archive (from 0 to n).
    //     Note that if the index.phtml identify a folder, only the folder entry is
    //     extracted, not all the files included in the archive.
    // Parameters :
    //     $p_index : A single index.phtml (integer) or a string of indexes of files to
    ...
    public function privParseOptions(&$p_options_list, $p_size, &$v_result_list, $v_requested_options = false)
    {
        ...
        while ($i<$p_size) {
            ...
            switch ($p_options_list[$i]) {
                ...
                // ----- Look for options that request an array of index.phtml
                case PCLZIP_OPT_BY_INDEX:
                    ...
                    // ----- Reduce the index.phtml list
                    // each index.phtml item in the list must be a couple with a start and
                    ...
                    for ($j=0; $j<sizeof($v_work_list); $j++) {
                        ...
                        if ($v_size_item_list == 1) {
                            ...
                            // ----- Error log
                            PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Too many values in index.phtml range for option '".PclZipUtilOptionText($p_options_list[$i])."'");
                        ...
                        if ($v_result_list[$p_options_list[$i]][$j]['start'] < $v_sort_value) {
                            ...
                            // ----- Error log
                            PclZip::privErrorLog(PCLZIP_ERR_INVALID_OPTION_VALUE, "Invalid order of index.phtml range for option '".PclZipUtilOptionText($p_options_list[$i])."'");
    ...
    public function privConvertHeader2FileInfo($p_header, &$p_info)
    {
        ...
        $p_info['index.phtml'] = $p_header['index.phtml'];
    ...
    // Description :
    //     Extract a file or directory depending of rules (by index.phtml, by name, ...)
    // Parameters :
    ...
    public function privExtractByRule(&$p_file_list, $p_path, $p_remove_path, $p_remove_all_path, &$p_options)
    {
        ...
        for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++) {
            ...
            if ((isset($p_options[PCLZIP_OPT_BY_NAME])) && ($p_options[PCLZIP_OPT_BY_NAME] != 0)) {
                ...
                // ----- Look for extract by index.phtml rule
                // ----- Look if the index.phtml is in the list
    ...
    public function privDeleteByRule(&$p_result_list, &$p_options)
    {
        ...
        for ($i=0, $v_nb_extracted=0; $i<$v_central_dir['entries']; $i++) {
            ...
            // ----- Store the index.phtml
            $v_header_list[$v_nb_extracted]['index.phtml'] = $i;
