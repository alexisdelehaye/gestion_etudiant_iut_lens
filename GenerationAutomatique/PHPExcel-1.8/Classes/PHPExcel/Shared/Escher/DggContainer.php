...
{
    /**
     * Maximum shape index.phtml of all shapes in all drawings increased by one
     *
     * @var int
     */
    private $spIdMax;
    ...
    /**
     * Get maximum shape index.phtml of all shapes in all drawings (plus one)
     *
     * @return int
     */
    ...
    /**
     * Set maximum shape index.phtml of all shapes in all drawings (plus one)
     *
     * @param int
     */
