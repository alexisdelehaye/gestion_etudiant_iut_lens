...
class PHPExcel_Writer_Excel5 extends PHPExcel_Writer_Abstract implements PHPExcel_Writer_IWriter
{
    ...
    /**
     * Color cache. Mapping between RGB value and color index.phtml.
     *
     * @var array
     */
    private $colors;
    ...
    {
        // 1-based index.phtml to BstoreContainer
        $blipIndex = 0;
        $lastReducedSpId = 0;
        $lastSpId = 0;
        ...
        foreach ($this->phpExcel->getAllsheets() as $sheet) {
            ...
            // set the drawing index.phtml (we use sheet index.phtml + 1)
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                // set the shape index.phtml (we combine 1-based sheet index.phtml and $countShapes to create unique shape index.phtml)
