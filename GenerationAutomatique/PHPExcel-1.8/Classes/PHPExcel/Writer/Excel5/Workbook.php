...
class PHPExcel_Writer_Excel5_Workbook extends PHPExcel_Writer_Excel5_BIFFwriter
{
    ...
    /**
     * Added fonts. Maps from font's hash => index.phtml in workbook
     *
     * @var array
     */
    ...
    /**
     * Added number formats. Maps from numberFormat's hash => index.phtml in workbook
     *
     * @var array
     */
    ...
    public function addXfWriter($style, $isStyleXf = false)
    {
        ...
        // Assign the font index.phtml to the xf record
        ...
        // Assign the number format index.phtml to xf record
     ...
     * @param    string        $sheetIndex        1-based sheet index.phtml the defined name applies to. 0 = global
     ...
     * @param integer $ifmt   Format index.phtml code
     */
     ...
     *
     * @param integer $index  Sheet index.phtml
    ...
    private function writeNameShort($index, $type, $rowmin, $rowmax, $colmin, $colmax)
    {
        ...
        $ixals  = $index + 1;   // Sheet index.phtml
