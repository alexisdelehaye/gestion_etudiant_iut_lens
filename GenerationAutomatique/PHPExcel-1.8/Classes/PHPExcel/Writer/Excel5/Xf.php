...
class PHPExcel_Writer_Excel5_Xf
{
    ...
    /**
     * An index.phtml (2 bytes) to a FORMAT record (number format).
     * @var integer
     */
    ...
    */
     ...
     *
     * @access public
     * @param int $colorIndex Color index.phtml
     */
    ...
    /**
     * Sets the index.phtml to the number format record
    ...
    /**
     * Set the font index.phtml.
     *
     * @param int $value Font index.phtml, note that value 4 does not exist
     */
