...
class PHPExcel_Calculation
{
    ...
    /**
     * Read the dimensions of a matrix, and re-index.phtml it with straight numeric keys starting from row 0, column 0
     *
    ...
    private function _parseFormula($formula, PHPExcel_Cell $pCell = null)
    {
        ...
        while (true) {
//echo 'Assessing Expression '.substr($formula, $index.phtml), PHP_EOL;
            $opCharacter = $formula{$index};    //    Get the first character of the value at the current index.phtml position
