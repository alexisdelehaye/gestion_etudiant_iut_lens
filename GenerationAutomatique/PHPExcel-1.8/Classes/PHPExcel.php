    ...
    */
    ...
    public function addSheet(PHPExcel_Worksheet $pSheet, $iSheetIndex = null)
    {
        ...
        if ($iSheetIndex === null) {
            ...
            // Insert the sheet at the requested index.phtml
            array_splice(
            ...
            // Adjust active sheet index.phtml if necessary
    ...
    /**
     * Remove sheet by index.phtml
     *
     * @param  int $pIndex Active sheet index.phtml
     * @throws PHPExcel_Exception
     */
    public function removeSheetByIndex($pIndex = 0)
    {
        ...
        if ($pIndex > $numSheets - 1) {
            throw new PHPExcel_Exception(
                "You tried to remove a sheet by the out of bounds index.phtml: {$pIndex}. The actual number of sheets is {$numSheets}."
            );
        } else {
    ...
    /**
     * Get sheet by index.phtml
     *
     * @param  int $pIndex Sheet index.phtml
     * @return PHPExcel_Worksheet
     * @throws PHPExcel_Exception
     */
    public function getSheet($pIndex = 0)
    {
        if (!isset($this->workSheetCollection[$pIndex])) {
            ...
            throw new PHPExcel_Exception(
                "Your requested sheet index.phtml: {$pIndex} is out of bounds. The actual number of sheets is {$numSheets}."
            );
        }
    ...
    /**
     * Get index.phtml for sheet
     *
     * @param  PHPExcel_Worksheet $pSheet
     * @return int Sheet index.phtml
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Set index.phtml for sheet by sheet name.
     *
     * @param  string $sheetName Sheet name to modify index.phtml for
     * @param  int $newIndex New index.phtml for the sheet
     * @return int New sheet index.phtml
     * @throws PHPExcel_Exception
     */
    ...
    /**
     * Get active sheet index.phtml
     *
     * @return int Active sheet index.phtml
     */
    ...
    public function setActiveSheetIndex($pIndex = 0)
    {
        ...
        if ($pIndex > $numSheets - 1) {
            throw new PHPExcel_Exception(
                "You tried to set a sheet active by the out of bounds index.phtml: {$pIndex}. The actual number of sheets is {$numSheets}."
            );
        } else {
    ...
    /**
     * Set active sheet index.phtml by name
     *
    ...
    /**
     * Remove cellXf by index.phtml. It is ensured that all cells get their xf index.phtml updated.
     *
    ...
    public function removeCellXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellXfCollection) - 1) {
            throw new PHPExcel_Exception("CellXf index.phtml is out of bounds.");
        } else {
            ...
            foreach ($this->workSheetCollection as $worksheet) {
                foreach ($worksheet->getCellCollection(false) as $cellID) {
                    ...
                    if ($xfIndex > $pIndex) {
                        // decrease xf index.phtml by 1
                        $cell->setXfIndex($xfIndex - 1);
                    } elseif ($xfIndex == $pIndex) {
                        // set to default xf index.phtml 0
                        $cell->setXfIndex(0);
                    }
                }
            }
    ...
    /**
     * Get cellStyleXf by index.phtml
     *
     * @param integer $pIndex Index to cellXf
     * @return PHPExcel_Style
     */
    ...
    /**
     * Remove cellStyleXf by index.phtml
     *
     * @param integer $pIndex Index to cellXf
     * @throws PHPExcel_Exception
     */
    public function removeCellStyleXfByIndex($pIndex = 0)
    {
        if ($pIndex > count($this->cellStyleXfCollection) - 1) {
            throw new PHPExcel_Exception("CellStyleXf index.phtml is out of bounds.");
        } else {
    ...
    public function garbageCollect()
    {
        ...
        // update the index.phtml for all cellXfs
